/**
 * 销售订单 InvAD（MF_POS + TF_POS，OS_ID=SO）
 * 同步自：docs/04_受订单_功能说明.md
 */
import type { ErpFieldMeta } from './types';

export const SO_BILL_HEAD: ErpFieldMeta[] = [
  ...
  { order: 4, dbField: 'CUS_NO', key: 'cus_no', label: '客户代号', query: true, list: true, form: true, required: true, widget: 'lookup', area: 'head', width: 100 },
  { order: 5, dbField: 'CUS_OS_NO', key: 'cus_os_no', label: '客户订单号', form: true, widget: 'input', area: 'head' },
  { order: 6, dbField: 'BIL_TYPE', key: 'bil_type', label: '单据类别', form: true, widget: 'lookup', area: 'head' },
  ...
  { order: 11, dbField: 'DIS_CNT', key: 'dis_cnt', label: '折扣%', widget: 'hidden', area: 'head' },
...
export const SO_BILL_LINE: ErpFieldMeta[] = [
