/**
 * 采购单明细（MF_POS + TF_POS 行级展开）
 */
import type { ErpFieldMeta } from './types';

export const PO_DETAIL_LINE: ErpFieldMeta[] = [
  ...
  { order: 3, dbField: 'CUS_NO', key: 'cus_no', label: '厂商代号', query: true, list: true, area: 'head', width: 100 },
  { order: 4, dbField: 'CUS_OS_NO', key: 'cus_os_no', label: '厂商订单号', list: true, area: 'head', width: 110 },
